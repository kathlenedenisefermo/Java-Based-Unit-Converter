 ...
 */
import javax.swing.*;
public class pressure_converter extends javax.swing.JFrame {

    /**
     * Creates new form pressure_converter
     */
    public pressure_converter() {
        initComponents();
    }
    ...
    private void convertPressure() {
        try {
            ...
            double convertedPressure = convertToPascals(inputValue, inputUnit);
            double result = convertFromPascals(convertedPressure, outputUnit);
    ...
    private double convertToPascals(double value, String inputUnit) {
        switch (inputUnit) {
            case "Pascals":
                return value;
            case "Kilopascals":
    ...
    private double convertFromPascals(double value, String outputUnit) {
        switch (outputUnit) {
            case "Pascals":
                return value;
            case "Kilopascals":
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pressure.png"))); // NOI18N
        ...
        outputUnitComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pascals", "Kilopascals", "Bars", "Atmospheres", "Torr", "Millimeters of Mercury", "Inches of Mercury", "Pounds per Square Inch" }));
        ...
        inputUnitComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pascals", "Kilopascals", "Bars", "Atmospheres", "Torr", "Millimeters of Mercury", "Inches of Mercury", "Pounds per Square Inch" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        convertPressure();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pressure_converter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pressure_converter().setVisible(true);
            }
        });
    }
