 ...
 */
import javax.swing.*;
public class speed_converter extends javax.swing.JFrame {

    /**
     * Creates new form speed_converter
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/speedometer.png"))); // NOI18N
        ...
        outputUnitComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "meter/second [m/s]", "kilometer/hour [km/h]", "mile/hour [mi/h]", "meter/hour [m/h]", "kilometer/minute [km/min]", "centimeter/minute [cm/min]", "millimeter/hour [mm/h]","foot/minute [ft/min]", "yard/hour [yd/h]", "mile/minute [mi/min]", "Velocity of light in vacuum" }));
        ...
        inputUnitComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "meter/second [m/s]", "kilometer/hour [km/h]", "mile/hour [mi/h]", "meter/hour [m/h]", "kilometer/minute [km/min]", "centimeter/minute [cm/min]", "millimeter/hour [mm/h]","foot/minute [ft/min]", "yard/hour [yd/h]", "mile/minute [mi/min]", "Velocity of light in vacuum" }));
    ...
    private void convertSpeed() {
        try {
            ...
            double convertedSpeed = convertToMeterPerSecond(inputValue, inputUnit);
            double result = convertFromMeterPerSecond(convertedSpeed, outputUnit);

            // Format the converted volume with specified decimal places if provided
            String formattedOutput;
            if (decimalPlacesText.isEmpty()) {
                formattedOutput = String.valueOf(result); // No rounding off
            } else {
                formattedOutput = String.format("%." + decimalPlaces + "f", result);
            }
    ...
    private double convertToMeterPerSecond(double value, String inputUnit) {
        switch (inputUnit) {
            ...
            case "kilometer/minute [km/min]":
                return value * 16.6667 / 60;
            case "centimeter/minute [cm/min]":
                return value / 60 / 100;
            case "millimeter/hour [mm/h]":
                return value / 3600 / 1000;
            case "foot/minute [ft/min]":
                return value * 0.00508 / 60;
            case "yard/hour [yd/h]":
                return value * 0.000254 / 3600;
            case "mile/minute [mi/min]":
                return value * 26.8224 / 60;
            case "Velocity of light in vacuum":
                return value / 299792458.0;
            default:
                return value; // Default to returning input value if unit is not recognized
        }
    }

    private double convertFromMeterPerSecond(double value, String outputUnit) {
        switch (outputUnit) {
            case "meter/second [m/s]":
                return value;
            case "kilometer/hour [km/h]":
            ...
            case "yard/hour [yd/h]":
                return value * 3937.00787;
            case "mile/minute [mi/min]":
                return value * 0.0372823;
            case "Velocity of light in vacuum":
                return value / 299792458.0;
            default:
                return value; // Default to returning input value if unit is not recognized
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        convertSpeed();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(speed_converter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new speed_converter().setVisible(true);
            }
        });
    }
