 ...
 */
import javax.swing.*;
public class volume_converter extends javax.swing.JFrame {

    /**
     * Creates new form volume_converter
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vol.png"))); // NOI18N
    ...
    private double convert(double value, String inputUnit, String outputUnit) {
        ...
        // Perform volume conversion based on input unit
        double volumeInMilliliters = convertToMilliliters(value, inputUnit);
        return convertFromMilliliters(volumeInMilliliters, outputUnit);
    }

    private double convertToMilliliters(double value, String unit) {
        switch (unit) {
            case "Kiloliters":
    ...
    private double convertFromMilliliters(double valueInMilliliters, String unit) {
        switch (unit) {
            case "Kiloliters":
                return valueInMilliliters / 1000000.0;
            case "Liters":
                return valueInMilliliters / 1000.0;
            case "Milliliters":
                return valueInMilliliters;
            case "Gallons":
                return valueInMilliliters / 3785.41;
            case "Quarts":
                return valueInMilliliters / 946.353;
            case "Pints":
                return valueInMilliliters / 473.176;
            case "Cups":
                return valueInMilliliters / 236.588;
            case "Fluid Ounces":
                return valueInMilliliters / 29.5735;
            case "Tablespoons":
                return valueInMilliliters / 14.7868;
            case "Teaspoons":
                return valueInMilliliters / 4.92892;
            default:
                return valueInMilliliters; // Default to returning value in milliliters if unit is not recognized
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        convertVolume();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(volume_converter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new volume_converter().setVisible(true);
            }
        });
    }
